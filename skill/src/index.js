...
var APP_ID = "amzn1.ask.skill.a7cfeb9b-cf76-4789-a727-253424344591";
...
var workoutDesc3 = "Each round will last for approximately three minutes. You can use my commands to shadowbox, work on a heavybag, or work mitts with a partner. ";
...
var thresholdA = 10;
var thresholdB = 30;
var endPointA = 5; // FIX: change if array size changes
var endPointB = 10; // FIX: change if array size changes
var maxNumCombos = 80;
...
function buildRound() { 
	var str = "jab " + break1; // first punch will always be a jab
	var startPt = 0;
	var endPt = endPointA;
	for(i = 1; i < maxNumCombos; ++i) { // punches in the amount of maxNumCombos will be returned
		str += punches[Math.floor(Math.random() * (endPt - startPt)) + startPt] + break1;
		if(i == thresholdA) { // only pull from a limited set until a certain threshold
			startPt = endPointA;
			endPt = endPointB;
		}
		else if(i == thresholdB) { // pull from all after another threshold
			startPt = 0;
			endPt = punches.length;
		}
	}
	return str;
}
