...
var promptToSayYesNo = "I don't understand. Please say yes for a punch combination, or say no to quit.";
...
// message to handle unrecognized utterances
var speechNotRecognized = "I didn't get that. " + helpMessage;
...
var helper = {
    ...
    */
    ...
    getSpeech: function () {
        ...
        return nodes[nodeIndex].message;
        /*
        for (var i = 0; i < nodes.length; i++) {
            if (nodes[i].node == nodeId) {
